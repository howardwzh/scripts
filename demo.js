    ...
    panel.innerHTML = `
      <div>
        ...
        >
          ...
          <p style="margin:16px 0 0"><label><span>SellPrice：</span><input style="width: 100%; height: 30px" type="text" id="sellPriceInput"/></label></p>
          <p style="margin:16px 0 0"><label><span>SoldNumber：</span><input style="width: 100%; height: 30px" type="text" id="soldNumberInput"/></label></p>
          <p style="margin:16px 0 0"><label><span>SoldMoney：</span><input style="width: 100%; height: 30px" type="text" id="soldMoneyInput"/></label></p>
          <p  style="margin:54px 0 0"><label><span>BuyPrice：</span><input style="width: 100%; height: 30px" type="text" id="buyPriceInput"/></label><span id="winNumber"></span></p>
