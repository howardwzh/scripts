    ...
    panel.innerHTML = `
      <div>
        ...
        >
          ...
          <p style="margin-top: 54px;"><label><span>BuyPrice：</span><input style="width: 100%; height: 30px" type="text" id="buyPriceInput"/></label><span id="winNumber"></span></p>
        ...
        <button id="toggleBtn" style="position: fixed; z-index: 7777777; width: 54px; height: 54px; opacity: 0.1; top: 350px; left: 50%; margin-left: -27px; border-radius: 50%; font-size: 14px; padding: 7px 14px;"></button>
      </div>
    `;
